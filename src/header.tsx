...
const popupElement = document.getElementById('loginPopup');
if (!popupElement) throw new Error('Failed to find the popup element');
const popup = ReactDOM.createRoot(popupElement);
