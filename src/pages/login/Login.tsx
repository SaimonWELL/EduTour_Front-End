...
const LoginScreen = () => {
    ...
    const { userInfo } = useSelector((state:any) => state.auth); //fix any//fix any//fix any//fix any//fix any//fix any!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    const submitHandler = async (e:React.SyntheticEvent<EventTarget>) => {
        ...
        try {
            ...
            navigate('/')
        }catch (err:any){ //fix any //fix any//fix any//fix any//fix any//fix any//fix any//fix any!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            ...
            <div className="flex flex-cobg-gray-50 dark:bg-gray-900l items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                <div
                    ...
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form className="space-y-4 md:space-y-6"  method='GET' onSubmit={ submitHandler } >
                            <div>
                                <label htmlFor="email"
                            ...
                            <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                                Не зарегестрированы? <Link to='/registration'>Ргистрация</Link>
                                {/*<a href='/registration'*/}
