...
import { newPassword } from "../../hooks/resetPassword";
...
export const ChangeUser = () => {
  ...
  const submitHandler = async (e: React.SyntheticEvent<EventTarget>) => {
    e.preventDefault();
    if (params.username) {
      const message = await changeUserHook(
        params.username,
        avatar,
        firstname,
        lastname,
  ...
  const submitNewPassword = async (e: React.SyntheticEvent<EventTarget>) => {
    e.preventDefault();
    if (params.username && newPass == confirmPassword) {
        newPassword(oldPassword, newPass, params.username);
    }
  };
