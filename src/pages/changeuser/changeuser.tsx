...
export const ChangeUser = () => {
  ...
  return (
      <div className="relative flex flex-col items-center pt-28 mb-28 rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-none">
        ...
        <h4 className="mt-4 block font-sans text-2xl font-semibold leading-snug tracking-normal text-blue-gray-900 antialiased">
          Изменить пароль
        </h4>
        <form
          className="mt-8 mb-10 w-80 max-w-screen-lg sm:w-96 "
          method="POST"
