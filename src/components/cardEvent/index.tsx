                ...
                <div className="info-block  h-52 px-4 relative bottom-5">
                    ...
                    <div className='footer flex flex-row pt-4 gap-9'>
                        <div className='tags flex flex-row  gap-2'>
                            <div className='w-24 h-8 border-2 border-[#F6F6F6] rounded-full flex flex-row items-center justify-center gap-2'>
                                <img src='/img/bambuk.png' className='w-[20px] h-[20px]' alt=""/>
                                <p className='font-rubick text-sm font-normal'>Очное</p>
                            </div>
                            <div className='w-28 h-8 border-2 border-[#F6F6F6] rounded-full flex flex-row items-center justify-center gap-0.5'>
                                <img src="/img/shotArrow.png" className='w-[20px] h-[20px] relative bottom-[0.5px]' alt=""/>
